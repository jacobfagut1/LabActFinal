...
SECRET_KEY = os.getenv('46+6b%u*z++=2n0di_m5h)4x0y1bco%^%$s+(!j&&d2ho&7$p2',  'fallback_dev_secret')
DEBUG = False
...
DATABASES = {
    'default': {
        ...
        'CLIENT':{
            'host': 'mongodb+srv://mjefagut01:UFN5ecIl0qJ1lCPY@cluster0.aju2t3o.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0',
        }
    }
}
